    ...
    <div id="services" className="bg-gray-100 py-12">
      ...
      <section data-aos="zoom-in-down">
        <div className="px-12" data-aos="fade-down" data-aos-delay="600">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 pt-6">
            ...
            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
              <div className="m-2 text-justify text-sm">
                ...
                <p className="text-md font-medium">
                  We specialize in networking solutions and professional router
                  installations for robust and secure network infrastructure,
      ...
      <section>
        <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6">
          <div
            ...
            data-aos="zoom-out"
          >
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center border rounded-md p-3 bg-slate-300">
            ...
            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center border rounded-md p-3 bg-slate-300">
              ...
              <div>
                <p className="my-3 text-xl text-gray-600 font-semibold">
                  ...
                  various processes. Your Scalability Partner.
                </p>
              </div>
            </div>
          </div>
